...
public class BufMgr implements GlobalConst{
  ...
  //the 3rd argument'int lastRef' couldn't be added because the code BMTest wouldn't run
    {
	...
	frmeTable[i] = new FrameDesc();
	  ...
	  {
        /*Assumed the value of lastRef is 2 since the argument
  		 * could not be added to the constructor of BufMgr
	    */
  ...
  public void pinPage(PageId pin_pgid, Page page, boolean emptyPage)
	   ...
	   IOException
    {
      ...
      if (replacer.name() == "LRUK"){
        // in LRUK replacement algorithm we need to get
        // the pageid of the page that is currently referenced to generate and update the history
